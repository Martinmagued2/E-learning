...
const SpotDifference = {
    ...
    hazards: [
        ...
        },
        {
            ...
            description: "منطقة عمل فوضوية مع أسلاك كهربائية متناثرة وسوائل قريبة من الأجهزة الكهربائية - خطر صعق كهربائي وحريق.",
            risk: "خطر عالي ⚠️",
            solution: "يجب إبعاد السوائل عن الأجهزة الكهربائية، وتنظيم الأسلاك بشكل آمن، وتنظيف منطقة العمل بشكل دوري."
        },
        {
            title: "� أوراق ونفايات متناثرة، وتخزين غير منظم",
            description: "مواد وصناديق مكدسة بطريقة عشوائية وغير مستقرة على الرفوف، قد تسقط وتسبب إصابات. أوراق ومواد قابلة للاشتعال متناثرة في منطقة العمل قد تسبب حريقاً.",
            risk: "خطر متوسط ⚠️",
            solution: "يجب تخزين المواد بشكل منظم ومستقر في الرفوف المخصصة (Organized Storage)، والأشياء الثقيلة في الأسفل. الحفاظ على نظافة منطقة العمل، فصل النفايات بشكل صحيح، وإبعاد المواد القابلة للاشتعال."
        }
    ],
